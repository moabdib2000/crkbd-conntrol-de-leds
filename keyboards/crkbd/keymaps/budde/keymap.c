...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT_kc( \
  //,-----------------------------------------.                ,-----------------------------------------.
      RST  ,  LRST, _____, _____, _____, _____,                   HOME,  PGDN,  PGUP,  END,  _____, _____,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      LTOG , LHUI , LSAI , LVAI , _____, _____,                   LEFT,  DOWN,    UP, RIGHT, _____, _____,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      LMOD , LHUD , LSAD , LVAD , _____, _____,                   MPLY,  VOLD,  VOLU,  MUTE, _____, _____,\
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
